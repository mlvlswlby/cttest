...
import com.subrutin.com.dao.impl.PostDaoImpl;
import com.subrutin.com.model.Post;

import io.agroal.api.AgroalDataSource;

@Path("/cttest/post")
public class CTPostResource {
    ...
    public String selectAll() {
    	String response = new Gson().toJson(postDao.selectAll(dataSource));
    	return response;
    }
    ...
    public String selectRow(@QueryParam("param") String param) {
    	String response = new Gson().toJson(postDao.selectRowByParam(dataSource, param));
    	return response;
    }
    ...
    public String selectData(@QueryParam("param") String param) {
    	String response = new Gson().toJson(postDao.selectData(dataSource, param));
    	return response;
    }
    ...
    public String updateData(@FormParam("param") String param, @FormParam("param2") String param2) {
    	try {
    		...
    		postDao.updateData(dataSource, param, param2);
    		return "SUCCESS";
    	}
    	catch(Exception e) {
    		return "FAILED";
    ...
    public String deleteData(@FormParam("param") String param) {
    	try {
    		...
    		postDao.deleteData(dataSource, param);
    		return "SUCCESS";
    	}
    	catch(Exception e) {
    		return "FAILED";
    ...
    public Response insertData(@RequestParam String param) {
    	try {
    		System.out.println(param);
    		Gson g = new Gson();
    		Post post = g.fromJson(param, Post.class);
    		postDao.insertData(dataSource, post);
    ...
    public Response insertDatas(@RequestParam String param) {
    	try {
    		...
    		ArrayList<Post> post = g.fromJson(param, postListType);
    		postDao.insertDatas(dataSource, post);
    		return Response.status(Status.ACCEPTED).build();
    	}
    	catch(Exception e) {
    		return Response.status(Status.BAD_GATEWAY).build();
